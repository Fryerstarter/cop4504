...
public class ServerWindows
{
	...
	public static ArrayList<String> ProcessInput(String clientInput)
	{
		...
		if(clientInput.equals("A") || clientInput.equals("a"))
		{
			...
			outputList=ExecuteCommand("date.exe /T");
			outputList.addAll(ExecuteCommand("time.exe /T"));
		}else if(clientInput.equals("B") || clientInput.equals("b"))
		{
			//output = "B";
			outputList= ExecuteCommand("net statistics workstation");
		...
		{
			//output = "D";
			outputList = ExecuteCommand("netstat.exe");
		}else if(clientInput.equals("E") || clientInput.equals("e"))
		{
			outputList = ExecuteCommand("whoami.exe");
		}else if(clientInput.equals("F") || clientInput.equals("f"))
		{
			outputList = ExecuteCommand("TASKLIST.exe");
